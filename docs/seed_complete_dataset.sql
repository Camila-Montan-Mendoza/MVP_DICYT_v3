...
-- 5. Partidas Concretas del Proyecto ("partida_concreta")
...
-- 6. Catálogo de Ítems Disponibles ("item" vinculados a id_partida_concreta)
INSERT INTO "item" ("id", "id_partida_concreta", "nombre") VALUES
