...
function runSegregatorTests() {
  ...
  console.assert(tramites[0].items[0].precioReferencial === 500, "Material price calculation failed");
  ...
  invalidActivoFijo.archivosRespaldo = [{ id: "res-1", nombre: "proforma.pdf", path: "proforma.pdf" }];
  ...
  console.assert(errors.some(e => e.includes("Custodio")), "Should report Custodio error");
