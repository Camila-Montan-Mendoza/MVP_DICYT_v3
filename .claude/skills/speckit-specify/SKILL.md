...
7. Write the specification to SPEC_FILE using the template structure, replacing placeholders with concrete details derived from the feature description (arguments) while preserving section order and headings, ensuring each User Story (HU) includes its corresponding mockup image link (`![Mockup HU-N](mockups/huN-[title].png)`).
