...
- Si el usuario autenticado no es investigador principal de *este* proyecto puntual, ni tiene rol Administrador de la DICyT o Resp. de Presupuestos, `GET /api/proyectos/[id]` responde `403` sin exponer ningún campo del proyecto (CA-6).
